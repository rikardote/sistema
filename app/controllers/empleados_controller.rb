class EmpleadosController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.pdf do
         render  :pdf => "file.pdf", :template => 'empleados/index.html.erb'
      end
    end
  end
  ...
  private
    ...
    def empleado_params
      params.require(:empleado).permit(
                                :num_empleado, :nombre, :apellido_materno, 
                                :apellido_paterno, :departamento_id,:centro_id, 
                                :puesto_id, :turno_id, :activo)
    end
end
