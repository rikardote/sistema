...
class CentrosControllerTest < ActionController::TestCase
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post :create, centro: { centro_descripcion: @centro.centro_descripcion, centro_iden: @centro.centro_iden }
    end
  ...
  test "should update centro" do
    patch :update, id: @centro, centro: { centro_descripcion: @centro.centro_descripcion, centro_iden: @centro.centro_iden }
    assert_redirected_to centro_path(assigns(:centro))
  end
